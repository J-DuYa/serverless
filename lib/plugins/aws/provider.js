      ...
      async function (functionName) {
        ...
        if (_.isObject(imageDefinedInProvider)) {
          ...
          if (imageDefinedInProvider.path) {
            return await this.resolveImageUriAndShaFromPath(imageName, imageDefinedInProvider.path);
          }
        ...
        return await this.resolveImageUriAndShaFromPath(imageName, imageDefinedInProvider);
      },
      { promise: true }
    ),
  })
